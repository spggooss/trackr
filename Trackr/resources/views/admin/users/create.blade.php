        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h2 class="text-lg font-medium leading-6 text-gray-900">{{ __('admin.users.create.title') }}</h2>
                    <form method="POST" action="{{ route('admin.webshop.users.store',[ 'webshop' => \Illuminate\Support\Facades\Auth::user()->webshop]) }}">
                        @csrf
                        <div class="mt-4">
                            <label for="name"
                        ...
                        <div class="mt-4">
                            <label for="password"
                                   class="block font-medium text-gray-700">{{ __('admin.users.create.password') }}*
                            </label>
